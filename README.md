All avvio dell'app viene montato il componente per l impostazione della passowrd,viene codificata e salvata. Dopo dicche vieen chiesta la password per l'accesso alla todo-list.
